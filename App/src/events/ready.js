...
module.exports = {
    ...
    execute(client) {
        ...
        const status = [
            ...
            // Games
            { activities: [{ name: games[randomGame], type: ActivityType.Playing }], status: 'idle' },
            { activities: [{ name: games[randomGame], type: ActivityType.Competing }], status: 'dnd' },
            { activities: [{ name: games[randomGame], type: ActivityType.Streaming, url: 'https://www.twitch.tv/directory' }] },
        ];
