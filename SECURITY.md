...
Be sure to download the latest release of the code, as earlier versions of the code may not be stable and may contain unsatisfactory bugs. The latest release of the code can be downloaded from the following link: [GitHub](https://github.com/FJrodafo/DiscordAPP/releases)/[GitLab](https://gitlab.com/FJrodafo/DiscordAPP/-/releases).

If there is no release, just download the latest commit from the main branch. The repository can be downloaded via a zip file by clicking the following link: [GitHub](https://github.com/FJrodafo/DiscordAPP/archive/refs/heads/main.zip)/[GitLab](https://gitlab.com/FJrodafo/DiscordAPP/-/archive/main/DiscordAPP-main.zip).

## Reporting a Vulnerability

If you have detected any security vulnerability, please report it by filling out a specialized form at the following link: [GitHub](https://github.com/FJrodafo/DiscordAPP/issues/new/choose)/[GitLab](https://gitlab.com/FJrodafo/DiscordAPP/-/issues/new).
